...
var img = new Image();
img.src = 'https://www.mariowiki.com/images/1/1b/ShellNSMB.png';
img.width = 30;
img.height = 30;
ctx.drawImage(img, 150, 150, 30, 30);
ctx.fill();
...
function drawImage(){
  ...
  ctx.beginPath();
  ctx.drawImage = 'https://www.mariowiki.com/images/1/1b/ShellNSMB.png';
...
function drawLives() {
  ctx.font = "18px Arial";
  ctx.fillStyle = "#fff";
  ctx.fillText("Block Breaker                Lives: "+lives, canvas.width-310, 20);
}
